    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> EditContact(Guid id)
        {
            ...
            var viewModel = new EditContactViewModel
            {
                ...
                //PrimaryEmail = contact.PrimaryEmail //Jordan added
            };
        ...
        public async Task<IActionResult> GetContacts()
        {
            ...
            var emailList = await _context.EmailAddresses.Where(e => contactList.Select(c => c.Id).Contains(e.Contact.Id)).ToListAsync();//Jordan added


            var contactViewModel = new ContactViewModel
            {
                Contacts = contactList, EmailAddresses = emailList.Select(e => new EmailViewModel
                {
                    Type = e.Type,
                    Email = e.Email
                }).ToList(),
            ...
            //return PartialView("_ContactTable", new ContactViewModel { Contacts = contactList }); //original
            return PartialView("_ContactTable", contactViewModel); //Jordan Added
        }
        ...
        public async Task<IActionResult> SaveContact([FromBody]SaveContactViewModel model)
        {
            ...
            contact.DOB = model.DOB;//Is there a missing part to include Address and Email Address. Could be why no email addresses are accessible on contact table page
